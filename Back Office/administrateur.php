            ...
            <body>
                <div class="main">
                    ...
                    <?php
                        ...
                        if(isset($_GET["modif"])) {
                            echo "<p class='msg'>La modification à bien était éfféctuée "
                            ;
                        }
                        ...
                        //On affiche les libellés des informations dans un tableau:
                            ...
                            echo "<thead>
                                ...
                                while ($donnees = $query->fetch()) {
                                    ...
                                    echo "<tr>
                                            <td>" . $donnees["id"] . "</td>
                                            <td>" . $donnees["nom"] . "</td>
                                            <td><a href ='include/formModifCategories.php?id=". $donnees["id"] ."'><img src='img/modifier.png' /></a></td>
                            ...
                            while ($donnees = $query->fetch()) {
                                ...
                                echo "<tr>
                                            ...
                                            <td>" . $donnees["mp"] . "</td>
                                            <td>" . $donnees["statut"] . "</td>
                                            <td><a href ='include/formModifUtilisateurs.php?id=". $donnees["id"] ."' ><img src='img/modifier.png' /></a></td>
                                            <td><a href='php/supprime.php?supType=" . $donnees["id"] . "'><img src='img/supprimer.png' /></a></td>
                                        </tr>";
